// api/criar-pagamento.js — VERSÃO STRIPE (para teste rápido, sem esperar o Mercado Pago)
//
...
export default async function handler(req, res) {
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      // metadata volta junto no webhook — é assim que sabemos qual reserva confirmar
